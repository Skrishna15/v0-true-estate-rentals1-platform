...
import { Building, DollarSign, TrendingUp, Users, Eye, Shield } from "lucide-react"
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6">
              <Link href="/wealth-map" className="font-semibold text-blue-600 flex items-center gap-2">
